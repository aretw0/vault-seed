...
1.  **Crie Novas Notas:** Sinta-se à vontade para criar novas notas em qualquer uma das pastas principais (`20 - Projetos`, `30 - Áreas`, `40 - Recursos`, `50 - Arquivo`).
2.  **Use os Templates:** A pasta `90 - Modelos` contém modelos úteis para diferentes tipos de notas (conceitos, planos de ação, etc.). Use-os para manter a consistência.
...
Consulte a pasta `99 - Meta e Anexos` para guias detalhados sobre como usar e otimizar seu vault, incluindo:
