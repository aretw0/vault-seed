...
echo "gh      : $(gh --version 2>/dev/null | head -1 || echo 'não instalado')"
echo "rg      : $(rg --version 2>/dev/null | head -1 || echo 'não instalado')"
echo "fd      : $(fd --version 2>/dev/null || echo 'não instalado')"
echo "jq      : $(jq --version 2>/dev/null || echo 'não instalado')"
echo "shfmt   : $(shfmt --version 2>/dev/null || echo 'não instalado')"
echo "======================="
