...
- `Daily Notes`: Essencial para o fluxo de trabalho diário. Pode funcionar como seu **Dashboard (Daily Driver)** se configurado para abrir ao iniciar. Configure para usar a pasta `10 - Diário` e o template `Template - Nova Nota Diaria`.
...
- **`Kanban`**: Criar quadros Kanban dentro do Obsidian (útil para `20 - Projetos`).
